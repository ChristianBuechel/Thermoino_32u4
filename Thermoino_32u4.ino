...
#define CTC_MAX_N 500 //on the 2560 we could use 2500
// max entries for complex time-course (500 + 1 zero)
// given a max ctc_bin_ms of 500ms we can define ctc_data of 250s = 4min 10s
...
volatile int16_t ctc_data[CTC_MAX_N + 1]; // internally we have to add a zero pulse at the end
